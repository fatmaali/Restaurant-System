    ...
    <div id="container">
        ...
        <div id="content">
          <div id="main_column">
            ...
            <div class="section_w590">
              <h2>Special Of Rosto</h2>
              <div class="section_w590_content">
                <p>Ay haga tetktb 3an l mat3m beel 3arrby</p>
                <p>Aktr akla btetlb mn 3andohom</p>
            ...
            <div class="section_w590">
              ...
              <div class="section_w590_content">
                ...
                <div class="popular_meal_box margin_r_60"> <a href="#"><img src="images/image_01.jpg" alt="" /></a>
                  <h3>New Dish One</h3>
                  ...
                  <a href="#">Order</a> </div>
                <div class="popular_meal_box"> <a href="#"><img src="images/image_02.jpg" alt="" /></a>
          ...
          <div id="side_column" >
            ...
            <div class="side_column_section"  id="nav" align="right">
              <h4>Our Address</h4>
      ...
      <div id="footer">
        <ul class="footer_menu">
          ...
          <li><a href="About.html">About</a></li>
          <li class="last_menu"><a href="Logout.html">Logout</a></li>
        </ul>
