    ...
    <div id="container">
      ...
      <div id="content_wrapper"  >
        <div id="content">
          ...
          <?php
require "evaluationclass.php";
$evaluation = new evaluation($_REQUEST["ID"]);
$evaluation->FoodQuality=$_REQUEST["Name"];
  $evaluation->TheMenu=$_REQUEST["Names"];
  $evaluation->Dishes=$_REQUEST["Named"];
   $evaluation->Service=$_REQUEST["Nam"];
    $evaluation->Tables=$_REQUEST["Namee"];
     $evaluation->WellCooked=$_REQUEST["Namees"];
      $evaluation->FoodIsServedImpeccably=$_REQUEST["Nameed"];
       $evaluation->RestaurantAtmosphere=$_REQUEST["Na"];
        $evaluation->PriceLevel=$_REQUEST["Nameee"];
         $evaluation->Music=$_REQUEST["Nameees"];
          $evaluation->ID=$_REQUEST["ID"];
         
         
    evaluation::StoreEvaluation($evaluation);
?>
