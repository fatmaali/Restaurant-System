...
<div id="wb_Form1" style="position:absolute;left:60px;top:290px;width:417px;height:100px;z-index:5;">

<form name ="partyform" method="post" action="ReservEdit1.php" onsubmit="return validateForm();" >

Enter The Tmail That Reseved For:<input type="text"  name="Email" />
